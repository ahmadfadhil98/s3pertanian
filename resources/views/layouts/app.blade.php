                    ...
                    {{-- <div class="flex items-center">
                        <img href="{{ route('dashboard') }}">
                            ...
                            <div class="flex-none h-full">
                                ...
                                @else
                                <button style="background-color: #078CAA;" onclick="location.href=' {{ route( 'login') }} '" class="transform hover:scale-95 duration-300 rounded focus:outline-none py-1.5 px-3 text-base font-bold text-white shadow-md">
                                    <div class="flex">
