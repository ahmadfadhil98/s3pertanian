    ...
    <div class="max-w-screen-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex mt-6">
                ...
                <div class="transform hover:scale-95 duration-300 bg-gray-300 w-full md:w-1/3 flex text-gray-400 pl-5 rounded-xl shadow-inner">
                    ...
                    <input wire:model="search" type="text" class="ml-4 w-full bg-gray-200 focus:outline-none py-2.5 pl-5 text-gray-600 placeholder-gray-400 rounded-tr-xl rounded-br-xl shadow-inner" placeholder="Ketik nama proses...">
                </div>
            </div>
                @if($isOpen)
