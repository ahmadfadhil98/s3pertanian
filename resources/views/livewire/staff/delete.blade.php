      ...
      <!--content-->
        ...
        <!--body-->
            <div class="text-center flex-auto justify-center mt-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 flex text-red-900 items-center mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div wire:click="hideDel()" class="mt-8 mb-10 text-center">
                ...
                <button style="background-color: #79052a;" wire:click="delete({{ $this->delId }})" class="transform hover:scale-95 duration-300 py-3 px-7 md:mb-0 bg-red-500 hover:bg-red-700 text-white text-sm shadow-md rounded-xl focus:outline-none">Hapus</button>
            </div>
        </div>
    </div>
    </div>
