            ...
            <form>
                <div class="sm:py-8 sm:px-6">
                    <div>
                        ...
                        <h2 class="text-center text-xl font-bold mb-4 text-gray-600">TAMBAH MAHASISWA</h2>
                    </div>
                <div>
                    <div class="mb-2">
                        <input wire:model="staffId" type="hidden" class="shadow appearance-none w-full py-2 px-3 text-blue-900">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input wire:model="nip" type="number" name="nip" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2" placeholder="Input NIP">
                    ...
                    <div class="mb-2">
                        <div class="flex text-sm text-gray-600 font-bold mb-2">
                            ...
                            <div class="ml-3">Nama staff</div>
                        </div>
                        <input wire:model="name" name="name" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2" placeholder="Input nama staff">
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" name="email" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none" placeholder="Input email staff">
