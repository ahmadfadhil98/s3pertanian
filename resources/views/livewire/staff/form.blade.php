    ...
    <div class="flex items-end justify-center min-h-screen text-center sm:block">
        ...
        <div class="inline-block align-bottom bg-gray-100 rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                ...
                <div>
                    <div class="mb-2">
                        <input wire:model="staffId" type="hidden" class="shadow appearance-none w-full py-2 px-3 text-blue-900 shadow-md">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input wire:model="name" name="name" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input nama staff">
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" name="email" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none shadow-md" placeholder="Input email staff">
