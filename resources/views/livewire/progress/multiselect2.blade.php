...
{{ Form::select('id_homestay',$matkuls,null,['id'=>'select','x-cloak','class'=>'hidden'])}}
...
<div x-data="{
                    ...
                    selectedValues(){
                        $wire.prosesId = this.selected.map((option)=>{
                ...
                }" x-init="loadOptions()" class="flex flex-col items-center w-full">
	...
	" />
      ...
      <div class="w-full px-4">
        <div x-show.transition.origin.top="isOpen()" class="absolute shadow top-100 bg-white z-40 w-full left-0 rounded max-h-select" x-on:click.away="close">
          <div class="flex flex-col w-full overflow-y-auto h-fit max-h-64">
