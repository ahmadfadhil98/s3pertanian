        ...
        <div class="flex mt-7">
            ...
            <div class="flex mt-6">
                <div class="w-full">
                    ...
                    <button style="background-color: #078CAA;" onclick="window.location='{{ route('ddisertasi',$disertasiId) }}'" class="transform hover:scale-95 duration-300 rounded-xl focus:outline-none py-2.5 px-7 text-base text-white shadow-md">
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tbody>
                        @foreach($lecturers as  $key=>$lecturer)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button style="background-color: #E42025;" onclick="window.location='{{ route('bimbingan.destroy',[$disertasiId,$lecturer]) }}'" class="transform hover:scale-95 duration-300 ml-1.5 rounded-full text-sm font-bold text-white py-3 px-3 focus:outline-none shadow-md">
