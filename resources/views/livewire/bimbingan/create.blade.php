                    ...
                    <tbody>
                        @foreach($lecturers as  $key=>$lecturer)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button style="background-color: #E42025;" onclick="window.location='{{ route('bimbingan',[$disertasiId,$lecturer]) }}'" class="transform hover:scale-95 duration-300 ml-1.5 rounded-full text-sm font-bold text-white py-3 px-3 focus:outline-none shadow-md">
