                ...
                <div class="sm:py-6 sm:px-6">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            ...
                            ['class' => 'w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2 shadow-md','id' => 'lecturer_id','wire:model'=>'lecturer_id','placeholder'=>'- Pilih dosen -'])}}
                        ...
                        <div>
                            ...
                            ['class' => 'w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none shadow-md','id' => 'position','wire:model'=>'position','placeholder'=>'- Pilih posisi dosen -'])}}
