      ...
      <!--content-->
        ...
        <!--body-->
            ...
            <div wire:click="hideDel()" class="mt-8 mb-10 text-center">
                ...
                <button wire:click="delete({{ $this->delId }})" class="py-3 px-7 md:mb-0 bg-red-500 hover:bg-red-700 text-white text-sm font-bold shadow-md rounded-xl focus:outline-none">Hapus</button>
            </div>
        </div>
    </div>
    </div>
