                ...
                <table class="table-fixed w-full mt-6">
                    <thead class="">
                        <tr class="">
                            ...
                            <th class="bg-yellow-300 text-gray-600 w-50">
                                <div class="flex pl-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <th class="bg-yellow-300 py-3 text-gray-600 w-50">
                    ...
                    <tbody class="">
                        @foreach($lecturers as  $key=>$lecturer)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button wire:click="edit({{ $lecturer->id }})"class="rounded-xl text-sm font-bold bg-green-500 hover:bg-green-700 text-white py-2.5 px-7 focus:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                    </button>
                                    <button wire:click="showDel({{ $lecturer->id }})"class="ml-1.5 rounded-xl text-sm font-bold bg-red-500 hover:bg-red-700 text-white py-2.5 px-7 focus:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
