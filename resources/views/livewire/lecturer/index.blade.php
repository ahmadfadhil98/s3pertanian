                ...
                <table class="table-fixed w-full mt-6">
                    <thead>
                        <tr>
                            ...
                            <th class="bg-yellow-300 py-3 text-gray-600 rounded-tr-xl rounded-br-xl w-70 ">
                                <div class="flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tbody>
                        @foreach($lecturers as  $key=>$lecturer)
                            <tr>
                                ...
                                <td class="text-left text-base text-gray-600 px-6">{{ $lecturer->nip }}</td>
                                <td class="text-left text-base text-gray-600 font-bold px-6">{{ $lecturer->name }}</td>
