                        ...
                        @foreach($lecturers as  $key=>$lecturer)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <button style="background-color: #AA073B;" wire:click="showDel({{ $lecturer->id }})"class="transform hover:scale-95 duration-300 ml-1.5 rounded-xl text-sm font-bold text-white py-3 px-7 focus:outline-none shadow-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
