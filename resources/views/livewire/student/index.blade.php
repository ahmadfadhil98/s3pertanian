                        ...
                        @foreach($students as  $key=>$student)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <button style="background-color: #E42025;" wire:click="showDel({{ $student->id }})" class="transform hover:scale-95 duration-300 rounded-full text-sm font-bold text-white py-3 px-3 focus:outline-none shadow-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
