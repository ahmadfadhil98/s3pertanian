            ...
            <form>
                <div class="sm:py-6 sm:px-6">
                    <div>
                        ...
                        <h2 class="mb-4 text-xl font-bold text-center text-gray-600">TAMBAH MAHASISWA</h2>
                    </div>
                    <div>
                        <div>
                        ...
                        <div>
                            ...
                            <input wire:model="email" type="email" name="email" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none shadow-md mb-2" placeholder="Input email mahasiswa">
                        ...
                        <div class="mb-2">
                            <div class="flex mb-2 text-sm font-bold text-gray-600">
                                ...
                                <div class="ml-3">Beasiswa</div>
                            </div>
                            <input wire:model="beasiswa" name="beasiswa" class="w-full py-2.5 px-4 text-sm text-gray-600 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input beasiswa jika ada">
                            @error('beasiswa') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                    </div>
