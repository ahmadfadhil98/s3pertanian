            ...
            <form>
                ...
                <div>
                    ...
                    <div class="mb-2">
                        ...
                        <input wire:model="nim" type="number" name="nim" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2" placeholder="Input NIM">
                    ...
                    <div class="mb-2">
                        ...
                        <input wire:model="name" name="name" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2" placeholder="Input nama mahasiswa">
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" name="email" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none" placeholder="Input email mahasiswa">
