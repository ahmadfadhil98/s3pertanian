            ...
            <form>
                <div class="sm:py-8 sm:px-6">
                    <div>
                        ...
                        <h2 class="text-center text-xl font-bold mb-4 text-gray-600">TAMBAH TOPIK DISERTASI</h2>
                    </div>
                <div>
                <div class="mb-2">
                ...
                <div>
                    ...
                    <input wire:model="name" name="name" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none" placeholder="Input topik disertasi">
