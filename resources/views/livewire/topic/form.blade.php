            ...
            <form>
                <div class="sm:py-6 sm:px-6">
                    <div>
                        ...
                        <h2 class="text-center text-xl font-bold mb-4 text-gray-600">TAMBAH BIDANG ILMU</h2>
                    </div>
                <div>
                <div class="mb-2">
                    <input wire:model="topicId" type="hidden" class="shadow appearance-none border w-full py-2 px-3 text-blue-900 shadow-md">
                </div>
                <div>
                    <div class="flex text-sm text-gray-600 font-bold mb-2">
                        ...
                        <div class="ml-3">Nama Bidang Ilmu</div>
                    </div>
