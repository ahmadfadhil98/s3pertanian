                ...
                <div class="w-full md:w-2/3">
                    <button style="background-color: #9E8235;" wire:click="showModal()" class="transform hover:scale-95 duration-300 rounded-xl focus:outline-none py-2.5 px-7 text-base text-white shadow-md">
                        ...
                        <div class="transform hover:scale-95 duration-300 bg-gradient-to-r from-green-800 to-green-500 w-full md:w-1/3 flex text-white pl-5 rounded-xl shadow-md">
                            ...
                            <input style="background-color: #057A55;" wire:model="search" type="text" class="ml-4 w-full focus:outline-none py-2.5 pl-5 text-white placeholder-green-200 rounded-tr-xl rounded-br-xl" placeholder="Ketik topik disertasi...">
                        </div>
                    </div>
                @if($isOpen)
                        ...
                        @foreach($topics as  $key=>$topic)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <button style="background-color: #AA073B;" wire:click="showDel({{ $topic->id }})"class="transform hover:scale-95 duration-300 rounded-xl text-sm font-bold text-white py-3 px-7 focus:outline-none shadow-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
