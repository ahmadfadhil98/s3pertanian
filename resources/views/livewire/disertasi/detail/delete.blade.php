      ...
      <!--content-->
        ...
        <!--body-->
            ...
            <div wire:click="hideDel()" class="mt-8 mb-10 text-center">
                ...
                <button style="background-color: #E42025;" wire:click="delete({{ $this->delId }},{{$this->idDel}})" class="transform hover:scale-95 duration-300 py-3 px-7 md:mb-0 bg-red-500 hover:bg-red-700 text-white text-sm shadow-md rounded-xl focus:outline-none">Hapus</button>
            </div>
        </div>
    </div>
    </div>
