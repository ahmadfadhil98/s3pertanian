                ...
                <div class="sm:py-6 sm:px-6">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model="content" name="content" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2 shadow-md" placeholder="Input link">
