      ...
      <!--content-->
        ...
        Halo
            <div class="text-center flex-auto justify-center mt-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 flex items-center text-red-500 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div wire:click="hideDel()" class="mt-8 mb-10 text-center">
                <button class="py-3 px-7 md:mb-0 bg-green-500 hover:bg-green-700 text-white text-sm font-bold shadow-md rounded-xl focus:outline-none mr-2">
                    Kembali
                </button>
                <button wire:click="delete({{ $this->delId }},{{$this->idDel}})" class="py-3 px-7 md:mb-0 bg-red-500 hover:bg-red-700 text-white text-sm font-bold shadow-md rounded-xl focus:outline-none">Hapus</button>
            </div>
        </div>
    </div>
    </div>
