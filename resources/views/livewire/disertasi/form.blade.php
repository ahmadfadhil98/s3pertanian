                ...
                <div class="sm:py-8 sm:px-6">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            ...
                            ['class' => 'w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2','id' => 'lecturer1','wire:click'=>'onChange()','wire:model'=>'lecturer1','placeholder'=>'- Pilih pembimbing 1 -'])}}
                        ...
                        <div class="mb-2">
                            ...
                            ['class' => 'w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2','id' => 'lecturer2','wire:click'=>'onChange2()','wire:model'=>'lecturer2','placeholder'=>'- Pilih pembimbing 2 -'])}}
                        ...
                        <div class="mb-2">
                            ...
                            ['class' => 'w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2','id' => 'lecturer3','wire:click'=>'onChange3()','wire:model'=>'lecturer3','placeholder'=>'- Pilih pembimbing 3 -'])}}
                        ...
                        <div>
                            ...
                            ['class' => 'w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none','id' => 'lecturer4','wire:model'=>'lecturer4','placeholder'=>'- Pilih pembimbing 4 -'])}}
