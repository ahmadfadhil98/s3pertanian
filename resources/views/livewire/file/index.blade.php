                    ...
                    <tbody>
                        @foreach($files as  $key=>$file)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button style="background-color: #078CAA;" wire:click="download({{ $file->id }})" class="transform hover:scale-95 duration-300 rounded-full text-sm font-bold text-white py-3 px-3 focus:outline-none shadow-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                    </button>
                                    @can('admin_manage_file')
                                        <button style="background-color: #E42025;" wire:click="showDel({{ $file->id }})" class="transform hover:scale-95 duration-300 ml-1.5 rounded-full text-sm font-bold text-white py-3 px-3 focus:outline-none shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
