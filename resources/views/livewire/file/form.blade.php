            ...
            <form>
                ...
                <div>
                    ...
                    <div class="mb-2">
                        ...
                        <input wire:model="name" name="name" class="w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none mb-2" placeholder="Input nama file">
                    ...
                    <div>
                        ...
                        <input type="file" wire:model="file" name="file" class="bg-white w-full py-2.5 px-4 text-sm text-gray-400 rounded-xl focus:outline-none">
