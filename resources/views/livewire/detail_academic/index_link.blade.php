    ...
    <div class="max-w-screen-xl mx-auto sm:px-6 lg:px-8">
        <div class="flex mt-7">
            ...
            <div class="flex mt-6">
                ...
                {{-- @if($isDel)
                    @include('livewire.detail_academic.delete')
                @endif --}}
                        ...
                        @foreach($academics as  $key=>$academic)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @can('admin_manage_academic')
                                        <button wire:click="showDel({{ $academic->id }})" class="rounded-xl text-sm font-bold bg-red-500 hover:bg-red-700 text-white py-2.5 px-7 ml-1.5 focus:outline-none shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
