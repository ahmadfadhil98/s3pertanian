                    ...
                    <tbody>
                        @foreach($academics as  $key=>$academic)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button style="background-color: #078CAA;" wire:click="showModal({{ $academic->id }})" class="transform hover:scale-95 duration-300 rounded-xl text-sm font-bold text-white py-3 px-7 focus:outline-none shadow-md">
